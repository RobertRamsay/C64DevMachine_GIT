...
draw_set_color(_grp_hov ? make_color_rgb(45, 150, 100) : make_color_rgb(25, 75, 55));
...
for (var _pos = 0; _pos < _disp_n; _pos++) {
    ...
    if (_row.kind == "group") {
        if (_row_y + item_h > panel_y + 66 && _row_y < _panel_bottom - 38) {
            ...
            var _gchev = "[+]";
            if (_row.open) _gchev = "[-]";
            draw_text_l(panel_x + 10, _row_y + 12,
                        _gchev + " " + _row.group + " (" + string(_row.count) + ")");
...
// Direct check: does any conflicted node overlap this asset?
    ...
    if (editing_name && editing_idx == _i) {
        ...
        draw_text_l(panel_x + 8, _iy + 16, ":::");
        draw_set_color(c_white);
        draw_text_l(panel_x + 30, _iy + 16, _asset.name);
    } else {
        draw_set_color(make_color_rgb(130, 150, 200));
        draw_text_l(panel_x + 8, _iy + 16, ":::");
        draw_set_color(c_white);
