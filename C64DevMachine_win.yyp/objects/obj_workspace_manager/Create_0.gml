...
//
// 0 = off. obj_mcp_probe is never created, and because every other reference
// to it in the project sits behind an instance_exists(obj_mcp_probe) guard,
// the whole feature goes inert: no MCP-CON / RESET buttons, no socket, no
