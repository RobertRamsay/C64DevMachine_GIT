...
if ((mouse_check_button_pressed(mb_middle) || mouse_check_button_pressed(mb_right) || keyboard_check_pressed(vk_space)) && !_any_node_dragging) {
    is_panning  = true;
