    ...
    static _map = {
        ...
        "MACRO_METASCROLL": {
            ...
            lines: [
                ...
                "",
                "COLOUR: FIXED writes one nibble at init and never",
                "touches $D800 again. SHIFT scrolls colour a frame",
                "after the chars, so for one frame in eight a cell",
                "wears its neighbour's colour - CPU speed cannot fix",
                "that, it is the sequencing. SHIFT C64U does both in",
                "one frame: clean on a C64 Ultimate in turbo, but it",
                "runs into the display on a stock 1 MHz machine.",
                "",
